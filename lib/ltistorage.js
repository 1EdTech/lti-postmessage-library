...
class LtiPostMessage {
    ...
    async sendPostMessageIfCapable(data) {
        ...
        return Promise.any([
            this.sendPostMessage({ subject: 'lti.capabilities' }, __classPrivateFieldGet(this, _LtiPostMessage_instances, "m", _LtiPostMessage_getTargetWindow).call(this), '*'),
            // Send new and old capabilities messages for support with pre-release subjects
            this.sendPostMessage({ subject: 'org.imsglobal.lti.capabilities' }, __classPrivateFieldGet(this, _LtiPostMessage_instances, "m", _LtiPostMessage_getTargetWindow).call(this), '*')
        ])
            .then((capabilities) => {
