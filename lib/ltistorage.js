...
class LtiPostMessage {
    ...
    sendPostMessageIfCapable(data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return this.sendPostMessage({ subject: 'lti.capabilities' }, __classPrivateFieldGet(this, _LtiPostMessage_instances, "m", _LtiPostMessage_getTargetWindow).call(this), '*')
                .then((capabilities) => {
